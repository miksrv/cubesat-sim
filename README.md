...
| [IoT Node(A) — 52Pi Docker Pi Series (GSM/GPS/LoRa)](docs/hardware-iot-node-a-52pi.md) | Onboard GSM/GPS/LoRa module, present on the build but not yet wired into any service — reserved for future ground-link/positioning work | — | [AliExpress](https://www.aliexpress.us/item/2251832864586218.html) | [52Pi Wiki](https://wiki.52pi.com/index.php?title=EP-0105) |
