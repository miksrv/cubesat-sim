...
| Board reboots during transmission (`rebootCount` climbing) | 915 MHz TX current peaks sagging the Pi 5V rail | Power over USB while debugging, or add a 100–470µF electrolytic across the Heltec supply |
